...
class _addbookState extends State<addbookpage> {
  ...
  Widget _getimage()
  {
    return  new Image.asset('assets/images/diary-y.png',
      height: 153.55,
      width: 109.25,
      fit: BoxFit.fill
      ,
  ...
  Widget build(BuildContext context) {
    ...
    return new Scaffold(
        ...
        appBar: new AppBar(
          leading: IconButton(icon: Icon(Icons.arrow_back,color: _defulcolor,), onPressed: () {Navigator.pop(context);}),
          backgroundColor: Colors.white,
          elevation: 0,
        ),
        body: SingleChildScrollView(
          child: new Column(
            ...
            children: <Widget>[
              Container(
                margin:
                    EdgeInsets.only(left: 36, right: 36, top: 10, bottom: 10),
